package com.testdev.cbzx.utils;
...
public class SqlHelper {
    //基本数据配置
    private String packageOutPath = "com.testdev.cbzx.entity";// 指定实体生成所在包的路径
    private String authorName = "cmj";// 作者名字
    private String tablename = "zt_lang";// 表名
    ...
    // 数据库连接
    private static final String URL = "jdbc:mysql://127.0.0.1:3306/cbzx?serverTimezone=GMT%2B8";
